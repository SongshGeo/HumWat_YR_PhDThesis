...
% 根据本研究的定义，人类活动主导下的人\textendash{}水关系是社会-水文二元循环中由人类主导的决策模式
...
\caption[定量识别流域水治理转变的分析框架]{
    定量识别流域水治理转变的分析框架。
    \textbf{A} 利用综合水治理指数（IWGI）识别水自然\textendash{}社会二元循环过渡时期中的水治理机制，可以从稀缺情况（S）、使用目的（P）和分配方式（A）这三方面切入，三者会随着人类活动主导社会-水文循环而变化。
